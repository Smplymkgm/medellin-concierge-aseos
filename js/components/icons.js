...
const icons = {
  _s: (d, w) => `<svg xmlns="http://www.w3.org/2000/svg" width="${w||24}" height="${w||24}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">${d}</svg>`,
